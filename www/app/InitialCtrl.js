...
function InitialCtrl(
    ...
    if (
      ...
      if (
        ...
        if (
          ...
          localAuthResponse != "null" &&
          localAuthResponse != "" &&
          localAuthResponse != undefined &&
          localAuthResponse != "undefined"
        ) {
          if (
            JSON.parse(localAuthResponse) != null &&
            JSON.parse(localAuthResponse) != "" &&
            JSON.parse(localAuthResponse) != undefined
          ) {
            if (true) {
  ...
  function checkAuthUser(authResponse) {
    return (
      authResponse.shopId != undefined &&
      authResponse.shopId != null &&
      authResponse.shopId != "" &&
      authResponse.branchId != undefined &&
      authResponse.branchId != null &&
      authResponse.branchId != "" &&
      authResponse.sessionId != undefined &&
      authResponse.sessionId != null &&
