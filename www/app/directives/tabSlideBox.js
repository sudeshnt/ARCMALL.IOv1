var tabSlideBox = angular.module('tabSlideBox',[]);

tabSlideBox.directive('onFinishRender', function ($timeout) {
  return {
    restrict: 'A',
...
tabSlideBox.directive('tabSlideBox', [ '$timeout', '$window', '$ionicSlideBoxDelegate', '$ionicScrollDelegate',
