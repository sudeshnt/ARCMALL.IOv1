...
CheckoutStep3Ctrl.$inject = ['$scope','$stateParams','$ionicHistory','PaypalFactory','$state','$rootScope','serverConfig','httpService','$httpParamSerializer'];

function CheckoutStep3Ctrl($scope, $stateParams,$ionicHistory,PaypalFactory,$state,$rootScope,serverConfig,httpService,$httpParamSerializer) {
   ...
   // function confirmOrder() {
    $scope.processOrder = function () {
        var key = Object.keys(JSON.parse($scope.payment_and_shipping.shipping_method).quote)[0]
