...
DashBoardCtrl.$inject = ['$scope', '$state', '$rootScope'];

function DashBoardCtrl($scope, $state, $rootScope) {
...
angular.module('dashboard.module').controller("DashBoardCtrl", ['$rootScope', "$scope", "$stateParams", "$q", "$location", "$window", '$timeout',


  function ($rootScope, $scope, $stateParams, $q, $location, $window, $timeout) {
    $scope.images = [{
      "image": "../app/modules/dashboard/img/her.png"
    }, {
      "image": "../app/modules/dashboard/img/her.png"
    }];
