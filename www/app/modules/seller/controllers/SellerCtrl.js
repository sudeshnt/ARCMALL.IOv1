...
SellerCtrl.$inject = ["$scope", "$state", "$rootScope"];

function SellerCtrl($scope, $state, $rootScope) {
...
angular.module("seller.module").directive("onFinishRender", function($timeout) {
  return {
    restrict: "A",
...
angular.module("seller.module").directive("tabSlideBox", [
  "$timeout",
  "$window",
...
// angular.module("signup.module").controller("SignUpCtrl", [
//   "$rootScope",
//   "$scope",
//   "$stateParams",
//   "$q",
