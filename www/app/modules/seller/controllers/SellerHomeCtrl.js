...
function SellerHomeCtrl(
  ...
  $scope.weightMeasures = ["Kilogram", "Gram", "Pound", "Ounce"];

  $scope.dimensionMeasures = ["Centimeter", "Millimeter", "Inch"];
  ...
  function getCurrency() {
    ...
    httpService
      .getRequest(serverConfig.clientAPI, extended_url, {})
  ...
  $scope.setItemCategory = function() {
    ...
    $scope.item.category.push({
      category_id:
        $scope.cat_tabs[$scope.category.catLevel1].categories[
          $scope.category.catLevel2
        ].category_id,
      name:
        $scope.cat_tabs[$scope.category.catLevel1].categories[
          $scope.category.catLevel2
    ...
    $scope.item.category.push({
      category_id:
        $scope.cat_tabs[$scope.category.catLevel1].categories[
          $scope.category.catLevel2
        ].categories[$scope.category.catLevel3].category_id,
      name:
        $scope.cat_tabs[$scope.category.catLevel1].categories[
          $scope.category.catLevel2
        ].categories[$scope.category.catLevel3].name
    });
  ...
  function uploadImage(newFileName) {
    ...
    if ($scope.selected_image_type === "Main") {
      ...
      url =
        "http://arcmall.alofatechlabs.com?route=api2/product/addproductimage";
    }
    ...
    $ionicLoading.show({
      template:
        '<ion-spinner icon="circles"></ion-spinner><br><span>Uploading</span>',
