...
function HomeCtrl(
  ...
  function initBanners() {
    ...
    httpService
      .postRequest(serverConfig.clientAPI, extended_url, {}, config)
      .then(function(response) {
        if (response.status === 200) {
  ...
  function initFeaturedProducts() {
    ...
    httpService
      ...
      .then(function(response) {
        if (response.status === 200) {
          $scope.featuredProducts = publicFunc.devideArray(
  ...
  $scope.showLogOutMenu = function() {
    var hideSheet = $ionicActionSheet.show({
      ...
      titleText:
        "Are you sure you want to logout? This app is awsome so I recommend you to stay.",
      cancelText: "Cancel",
      cancel: function() {},
