...
angular.module('test.module').controller('TestCtrl',TestCtrl );

TestCtrl.$inject = ['$scope','$state','$rootScope'];

function TestCtrl($scope,$state,$rootScope) {
...
angular.module('test.module').directive('onFinishRender', function ($timeout) {
    return {
      restrict: 'A',
...
angular.module('test.module').directive('tabSlideBox', [ '$timeout', '$window', '$ionicSlideBoxDelegate', '$ionicScrollDelegate',
...
angular.module('test.module').controller("IndexCtrl", ['$rootScope', "$scope", "$stateParams", "$q", "$location", "$window", '$timeout',
