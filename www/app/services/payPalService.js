  ...
  function PaypalFactory($q, $filter, $timeout, $ionicPlatform, serverConfig) {
    ...
    var configuration = function() {
      ...
      var config = new PayPalConfiguration({
        merchantName: serverConfig.payPal.payPalShopName,
        merchantPrivacyPolicyURL:
          serverConfig.payPal.payPalMerchantPrivacyPolicyURL,
        merchantUserAgreementURL:
          serverConfig.payPal.payPalMerchantUserAgreementURL
      });
      return config;
    };
